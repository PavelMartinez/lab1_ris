...
CREATE TABLE `product` (
  ...
  `prod_measure` varchar(2) NOT NULL,
  `prod_price` int NOT NULL,
  `prod_reg` datetime DEFAULT NULL,
  PRIMARY KEY (`prod_id`)
...
INSERT INTO `product` VALUES (1,'Сметана','гр',130,'2023-09-01 12:36:17'),(2,'Яблоко','гр',40,'2023-09-17 18:40:15'),(3,'Арбуз','кг',310,'2022-01-01 15:44:15');
